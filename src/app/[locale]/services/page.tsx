...
export async function generateMetadata({
  ...
  return {
    title: c.seo.services.title,
    description: c.seo.services.description,
    alternates: alternatesFor('/services', locale as Locale),
    openGraph: openGraphFor(c, '/services', locale as Locale, 'services'),
    twitter: twitterFor(c, 'services'),
  };
}
